...
9. Validate front matter, cover identifiers, length, TOC, figures, tables, diagram colors, code figure text, project evidence coverage, OpenXML schema, and outline before saying the draft is ready.
